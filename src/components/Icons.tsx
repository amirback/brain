...
export function IconTarget({ size = 24, className }: P) {
  return (
    <svg {...base(size)} className={className}>
      ...
      <circle cx="12" cy="12" r="2" fill="#ff6b1f" />
    </svg>
  );
}
...
export function IconMap({ size = 24, className }: P) {
  return (
    <svg {...base(size)} className={className}>
      <rect x="3" y="3" width="7.5" height="7.5" rx="2" fill="#ff6b1f" />
      ...
      <rect x="13.5" y="13.5" width="7.5" height="7.5" rx="2" fill="#ff6b1f" opacity="0.45" />
    </svg>
  );
}
...
export function IconChart({ size = 24, className }: P) {
  return (
    <svg {...base(size)} className={className}>
      ...
      <rect x="10.2" y="8" width="3.6" height="9" rx="1.2" fill="#ff6b1f" />
...
export function IconTrend({ size = 24, className }: P) {
  return (
    <svg {...base(size)} className={className}>
      <path d="M3 16.5l5-5 3.5 3.5L20 6.5" stroke="#ff6b1f" {...S} />
      <path d="M15 6.5h5v5" stroke="#ff6b1f" {...S} />
  ...
  return (
    <svg {...base(size)} className={className}>
      <path
        ...
        fill="#ff6b1f"
      />
      <path d="M12 20c-1.4 0-2.4-1.3-2.4-2.9 0-1.6 1.1-2.3 1.7-3.4.7 1 2.6 1.8 2.6 3.4 0 1.6-.5 2.9-1.9 2.9z" fill="#f2a018" />
    </svg>
  );
}
...
export function IconClock({ size = 24, className }: P) {
  return (
    <svg {...base(size)} className={className}>
      <circle cx="12" cy="12" r="9" stroke="currentColor" {...S} />
      <path d="M12 7.5V12l3 2" stroke="#ff6b1f" {...S} />
    </svg>
  );
}
...
export function IconTrophy({ size = 24, className }: P) {
  return (
    <svg {...base(size)} className={className}>
      <path d="M7 4h10v4.5a5 5 0 01-10 0V4z" fill="#ff6b1f" />
...
export function IconBolt({ size = 24, className }: P) {
  return (
    <svg {...base(size)} className={className}>
      <path d="M13.5 2.5L5 13.2h5.2L9.8 21.5 18.5 10.6h-5.3l.3-8.1z" fill="#ff6b1f" />
    </svg>
  );
}
...
export function IconBook({ size = 24, className }: P) {
  return (
    <svg {...base(size)} className={className}>
      <path d="M4 5.2C4 4.3 4.8 3.6 5.7 3.7L11 4.4v15.9l-5.4-.7A1.7 1.7 0 014 17.9V5.2z" fill="#ff6b1f" opacity="0.9" />
...
export function IconTeacher({ size = 24, className }: P) {
  return (
    <svg {...base(size)} className={className}>
      ...
      <path d="M6.5 8.5h6M6.5 11.5h4" stroke="#ff6b1f" {...S} />
...
export function IconParent({ size = 24, className }: P) {
  return (
    <svg {...base(size)} className={className}>
      <circle cx="8.5" cy="7" r="3" fill="#ff6b1f" />
...
export function IconCheck({ size = 24, className }: P) {
  return (
    <svg {...base(size)} className={className}>
      <circle cx="12" cy="12" r="9" fill="#ff6b1f" />
      <path d="M8 12.3l2.7 2.7L16 9.5" stroke="#fffdf8" strokeWidth="2.1" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
export function IconSpark({ size = 24, className }: P) {
  return (
    <svg {...base(size)} className={className}>
      <path d="M12 2.8l1.9 5.6 5.6 1.9-5.6 1.9L12 17.8l-1.9-5.6-5.6-1.9 5.6-1.9L12 2.8z" fill="#ff6b1f" />
      <path d="M18.6 15.4l.8 2.2 2.2.8-2.2.8-.8 2.2-.8-2.2-2.2-.8 2.2-.8.8-2.2z" fill="#f2a018" />
    </svg>
  );
}
...
export function IconRefresh({ size = 24, className }: P) {
  return (
    <svg {...base(size)} className={className}>
      ...
      <path d="M20 4v4.5h-4.5" stroke="#ff6b1f" {...S} />
    </svg>
  );
}
...
export function IconHelp({ size = 24, className }: P) {
  return (
    <svg {...base(size)} className={className}>
      <circle cx="12" cy="12" r="9" stroke="currentColor" {...S} />
      <path d="M9.5 9.3a2.6 2.6 0 015 .9c0 1.7-2.5 2.1-2.5 3.8" stroke="#ff6b1f" {...S} />
      <circle cx="12" cy="17" r="1.1" fill="#ff6b1f" />
    </svg>
  );
}
...
export function IconLink({ size = 24, className }: P) {
  return (
    <svg {...base(size)} className={className}>
      ...
      <path d="M13.5 10.5a4 4 0 00-5.7 0L5 13.3a4 4 0 105.7 5.7l1.4-1.4" stroke="#ff6b1f" {...S} />
    </svg>
  );
}
...
export function IconGrid({ size = 24, className }: P) {
  return (
    <svg {...base(size)} className={className}>
      ...
      <rect x="14.8" y="9.2" width="5.7" height="5.6" fill="#ff6b1f" opacity="0.85" />
    </svg>
  );
}
...
export function LogoMark({ size = 34, className = "" }: { className?: string; size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 36 36" fill="none" className={className} aria-hidden="true">
      <rect x="1.2" y="1.2" width="33.6" height="33.6" rx="10" stroke="#c9b994" strokeWidth="1.6" />
      <path d="M11 10.5H9.5A2.5 2.5 0 007 13v3.2c0 1-.8 1.8-1.8 1.8 1 0 1.8.8 1.8 1.8V23a2.5 2.5 0 002.5 2.5H11" stroke="#ff6b1f" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M25 10.5h1.5A2.5 2.5 0 0129 13v3.2c0 1 .8 1.8 1.8 1.8-1 0-1.8.8-1.8 1.8V23a2.5 2.5 0 01-2.5 2.5H25" stroke="#ff6b1f" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
      <circle cx="18" cy="18" r="3.4" fill="#ff6b1f" />
      <circle cx="18" cy="18" r="6.6" stroke="#ff6b1f" strokeWidth="1.4" opacity="0.35" />
    </svg>
  );
}
